...
def generate_cash_reciept(df,other_list):
    ...
    c.drawString(10.67*inch,11.2*inch,str(other_list[4]))
    ##############################################################################################################
    ...
    c.drawString(14.99*inch,9.65*inch,str(other_list[3]))
    ##############################################################################################################
    ...
    c.setFont('Times-Bold',19)
    c.drawString(14.99*inch,9.03*inch,str(other_list[0]))
    ##############################################################################################################
    ...
    c.setFont('Times-Bold',19)
    c.drawString(14.99*inch,8.37*inch,str(other_list[2]))
    ##############################################################################################################
    ...
    c.setFont('Times-Bold',19)
    c.drawString(15.0*inch,7.57*inch,str(other_list[1]))
    ##############################################################################################################
    ...
    for row in range(df.shape[0]):
        ...
        for col in df.columns:
            if x==0:
                c.drawString(35,9.0*inch-(50*row),str(df[col][row]))
            elif x==1:
                c.drawString(500.2,9.0*inch-(50*row),str(df[col][row]))
            else:
                c.drawString(1000,9.5*inch-(50*row),str(df[col][row]))
