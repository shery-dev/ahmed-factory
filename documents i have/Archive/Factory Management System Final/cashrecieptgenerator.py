...
def generate_cash_reciept(df,other_list):
    ...
    #my_path = my_path + "_" + str(other_list[4]) + "_" + str(other_list[5]) + "_" + str(other_list[6])
    ##############################################################################################################
    ...
    while(current_page<=page_count):
        ...
        c.setFont('Times-Bold',19)
        c.drawString(15.7*inch,8.398*inch,str(other_list[2]))
        ##############################################################################################################
        ...
        c.setFont('Times-Bold',19)
        c.drawString(15.7*inch,7.63*inch,str(other_list[9]))
        ##############################################################################################################
        ...
        c.setFont('Times-Bold',19)
        c.drawString(15.7*inch,7.63*inch,str(other_list[10]))
        ##############################################################################################################
        ...
        # ##############################################################################################################
        c.setFont('Times-Bold',25)
        c.drawString(13.0*inch,0.5*inch,'PTCL:')
        c.setFont('Courier',25)
        c.drawString(13.0*inch,0*inch,'042-37149081')
        ##############################################################################################################
